...
public abstract class Puzzle {
    ...
    private Random r = getSecureRandom();
    public static final Random getSecureRandom() {
		return new Random();
    }
     ...
     */
    public final String generateSeededScramble(long seed) {
        ...
        Random r = getSecureRandom();
        r.setSeed(seed);
        return generateWcaScramble(r);
    }
    public final String[] generateSeededScrambles(long seed, int count) {
        // We must create our own Random because
        // other threads can access the static one.
        // Also, setSeed supplements an existing seed,
        // rather than replacing it.
